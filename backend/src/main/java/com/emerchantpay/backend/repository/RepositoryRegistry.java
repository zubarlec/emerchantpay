...
import com.emerchantpay.backend.repository.account.AccountRepository;
...
public class RepositoryRegistry {
	...
	public RepositoryRegistry(
		...
		AuthorizeTransactionRepository authorizeTransaction,
		ChargeTransactionRepository chargeTransaction,
		RefundTransactionRepository refundTransaction,
		ReversalTransactionRepository reversalTransaction,
